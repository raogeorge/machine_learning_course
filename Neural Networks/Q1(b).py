...
def initialize_weights(input_size, hidden_sizes, output_size):
    """Initialize weights and biases with standard Gaussian distribution"""
    weights = []
    biases = []
...
if __name__ == "__main__":
    ...
    for width in widths:
        ...
        train_losses, train_errors, test_errors, _, _ = train_network(
            X_train, y_train, X_test, y_test,
            hidden_width=width,
            gamma0=0.1,  # Need to tune this
            d=100,       # Need to tune this
            max_updates=1000
        )
        ...
        plt.title(f'Training Loss vs Updates (Width={width})')
        ...
        plt.title(f'Error Rates vs Updates (Width={width})')
        plt.xlabel('Number of Updates')
